...
SECRET_KEY = 'django-insecure-h!k3t3w#*2(($_-qw^3hys0ng#u@#k@akw2kyvhw4+%yj^z1&7'
...
INSTALLED_APPS = [
    ...
    'photoexp.apps.PhotoexpConfig',
    'kategories.apps.KategoriesConfig',
    'crm.apps.CrmConfig',
